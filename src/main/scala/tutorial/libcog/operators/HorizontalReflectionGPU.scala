...
/**
  * A simple example demonstrating a GPU Operator
  * This GPU operator does horizontal reflection of an image
  */

object HorizontalReflectionGPU extends App {
  ...
  val cg = new ComputeGraph {
    ...
    val imgReflection = horizontalReflection(img.toVectorField)
    probeAll
  }
